...
{
  [Authorize] // Block unauthorized calls to this controller
  public class GalleryController : Controller
  {
    ...
    public async Task<IActionResult> EditImage(Guid id)
    {
      ...
      using (var responseStream = await response.Content.ReadAsStreamAsync())
      {
        ...
        if (deserializedImage == null) throw new Exception("Deserialized image must not be null.");
    ...
    //[Authorize(Roles="PayingUser")]  //RBAC
    [Authorize(Policy = PolicyNames.UserCanAddImage)] //ABAC
    ...
    public async Task LogIdentityInformation()
    {
      ...
      _logger.LogInformation("Identity token & user claims:\n{IdentityToken}\n{Claims}",identityToken,userClaimsStringBuilder);
