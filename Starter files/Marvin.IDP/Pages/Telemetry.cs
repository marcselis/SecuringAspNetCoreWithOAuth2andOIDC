...
#pragma warning restore 1591
          ...
          public static void ConsentDenied(string clientId, IEnumerable<string> scopes)
          {
              ...
              foreach (var scope in scopes)
              {
                  ConsentCounter.Add(1, new KeyValuePair<string, object?>(Tags.Client, clientId), new KeyValuePair<string, object?>(Tags.Scope, scope), new KeyValuePair<string, object?>(Tags.Consent, TagValues.Denied));
              }
          }
          ...
          public static void UserLogin(string? clientId, string idp)
              => UserLoginCounter.Add(1, new KeyValuePair<string, object?>(Tags.Client, clientId), new KeyValuePair<string, object?>(Tags.Idp, idp));
          ...
          public static void UserLoginFailure(string? clientId, string idp, string error)
              => UserLoginCounter.Add(1, new KeyValuePair<string, object?>(Tags.Client, clientId), new KeyValuePair<string, object?>(Tags.Idp, idp), new KeyValuePair<string, object?>(Tags.Error, error));
